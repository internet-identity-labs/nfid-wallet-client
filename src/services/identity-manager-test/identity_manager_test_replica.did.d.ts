...
export interface PersonaRequest { 'domain' : string, 'persona_id' : string }
export interface PersonaResponse { 'domain' : string, 'persona_id' : string }
...
export interface _SERVICE {
  ...
  'is_over_the_application_limit' : (arg_0: string) => Promise<
      BoolHttpResponse
    >,
  'lookup' : (arg_0: bigint) => Promise<[Array<Principal>, Principal]>,
