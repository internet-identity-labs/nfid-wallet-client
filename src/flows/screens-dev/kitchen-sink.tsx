              ...
              <Card>
                <CardBody className="p-4">
                  ...
                  <P>
                    ...
                    dolor deleniti odio dignissimos voluptatum inventore sequi
                    sed quisquam
                  </P>
              ...
              <Card className="flex flex-col h-full">
                ...
                <CardBody className="p-4">
                  <P>
                    ...
                    molestiae quod, voluptate distinctio fugit reiciendis id
                    eaque necessitatibus eveniet. Eveniet nihil voluptatibus
                    quae corrupti.
                  </P>
                </CardBody>
                    ...
                    <List>
                      <List.Items>
                        ...
                        <ListItem
                          ...
                          icon={
                            <MdLaptopMac className="text-xl text-gray-600" />
                          }
