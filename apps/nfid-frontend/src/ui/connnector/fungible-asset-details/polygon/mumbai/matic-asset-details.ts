...
export class MaticMumbaiAssetDetailsConnector extends FungibleAssetDetailsConnector {
...
export const maticMumbaiAssetDetailsConnector =
  new MaticMumbaiAssetDetailsConnector({
    icon: MaticSvg,
