...
Feature:Non Fungible Asset Details
  ...
  Scenario Outline: User should be able to see details page
    ...
    Examples:
      ...
      | 31870  |               | Rarible    | NFID   | 86090545217057429589019094455964497579787873809883022909766658167983963111527 | ERC721    | 0xd8560c88d1dc85f9ed05b25878e366c49b68bef9 |              | video       |
