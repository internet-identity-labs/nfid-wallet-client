...
describe("Passkey flow", () => {
  ...
  it('should register NFID with the passkey', async () => {
    ...
    jest.spyOn(passkeyService as any, 'createNavigatorCredential').mockResolvedValue(
      Promise.resolve({
        ...
        response: {
          attestationObject: "o2NmbXRkbm9uZWdhdHRTdG10oGhhdXRoRGF0YViYSZYN5YgOjGh0NBcPZHZgW4_krrmihjLHmVzzuoMdl2NdAAAAAPv8MAcVTk7MjAtuAgVX170AFF_8nsSuzlS1Kt0SHIVKfChRmZ7epQECAyYgASFYIHMCFeBD5B2ZNr1xtFdYYc-WTfEmtVnXMUBViJ5fKXNNIlgg85RwZ-N-NPyDyzj2JSxHbMCeQx0lUwzU46khrVvMhPE",
          authenticatorData: "SZYN5YgOjGh0NBcPZHZgW4_krrmihjLHmVzzuoMdl2NdAAAAAPv8MAcVTk7MjAtuAgVX170AFF_8nsSuzlS1Kt0SHIVKfChRmZ7epQECAyYgASFYIHMCFeBD5B2ZNr1xtFdYYc-WTfEmtVnXMUBViJ5fKXNNIlgg85RwZ-N-NPyDyzj2JSxHbMCeQx0lUwzU46khrVvMhPE",
          ...
          publicKey: "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEcwIV4EPkHZk2vXG0V1hhz5ZN8Sa1WdcxQFWInl8pc03zlHBn4340_IPLOPYlLEdswJ5DHSVTDNTjqSGtW8yE8Q",
    ...
    jest.spyOn(passkeyService as any, 'decodePublicKeyCredential').mockReturnValue(
      exp
    );
    ...
    let actual = await passkeyService.registerWithPasskey("mockedId", { isMultiDevice: false });
    ...
    expect(actual.accessPoints[0].principalId).toEqual(identity.getPrincipal().toText());
    ...
    expect(actual.accessPoints[0].credentialId).toEqual("Dst6_Arh95HGTVwUnp5zEtad_Bo");
