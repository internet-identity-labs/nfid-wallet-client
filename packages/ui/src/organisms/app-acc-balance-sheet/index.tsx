...
import { AccountBalance, AppBalance } from "@nfid/integration/asset/types"
import toaster from "@nfid/ui/atoms/toast"

import { Tooltip, CenterEllipsis, ApplicationIcon } from "@nfid/ui"
import { Blockchain } from "@nfid/integration/token/types"

import { ProfileConstants } from "frontend/apps/identity-manager/profile/routes"
import { TableBase, TableHead, TableWrapper } from "@nfid/ui/atoms/table/index"

interface GridCellProps extends React.TdHTMLAttributes<HTMLTableCellElement> {
  className?: string
...
export interface AppAccountBalanceSheetProps {
  apps: AppBalance[]
  currency?: string
  blockchain?: string
  toPresentation?: (balance?: bigint) => number | string
