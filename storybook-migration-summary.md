...
- `yarn storybook@latest automigrate --config-dir apps/nfid-frontend/.storybook --renderer @storybook/react`

- `yarn storybook@latest automigrate --config-dir packages/ui/.storybook --renderer @storybook/react`
