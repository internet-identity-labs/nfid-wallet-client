...
Feature:Non Fungible Asset Details
  ...
  Scenario Outline: User should be able to see details page
    ...
    Examples:
      | anchor | token         | collection | wallet | id                                                                            | standard  | collection_id                              | about        |
      | 31870  | AnilAnimal    | Rarible    | NFID   | 22558361690228810656161743101174268944760789894532108532742266930527975981633 | ERC1155   | 0x67a8fe17db4d441f96f26094677763a2213a3b5f | Testing      |
      | 31870  | TestERC1155   | Rarible    | NFID   | 94667527331073441490639696296732950748865385440430584394830104056550742032385 | ERC1155   | 0x7c4b13b5893cd82f371c5e28f12fb2f37542bbc5 | Test ERC1155 |
      | 31870  | PandaQueen571 | PandaQueen | NFID   | jzwaa-zikor-uwiaa-aaaaa-b4avk-qaqca-aaai5-q                                   | legacy1.5 | zhibq-piaaa-aaaah-qcvka-cai                | Panda Queen  |
