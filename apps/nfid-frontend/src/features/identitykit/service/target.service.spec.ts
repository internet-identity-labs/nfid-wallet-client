...
describe("Target service test suite", () => {
  ...
  it("should fail on undefined targets", async function () {
  ...
  it("should fail on no icrc10_supported_standards method", async function () {
  ...
  it("should fail on no icrc1 in icrc10_supported_standards method", async function () {
  ...
  it("should fail on no icrc7 in icrc10_supported_standards method", async function () {
