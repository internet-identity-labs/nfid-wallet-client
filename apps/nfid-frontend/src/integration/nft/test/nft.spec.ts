...
const mockCollections = [
  {
    id: "64x4q-laaaa-aaaal-qdjca-cai",
    priority: 1,
    name: "Cellphones",
    brief: "",
    description: "Cellphones on ICP ringing throughout the cryptoverse.",
    blurb: "",
    keywords: "",
    web: "",
    telegram: "",
  ...
  {
    id: "p5jg7-6aaaa-aaaah-qcolq-cai",
    priority: 1,
    name: "ICAliens",
    brief: "",
    description: "",
  ...
  {
    id: "gdeb6-lqaaa-aaaah-abvpq-cai",
    priority: 1,
    name: "Boxy Land",
    brief: "",
    description:
  ...
  {
    id: "gfcya-pyaaa-aaaan-qbxda-cai",
    priority: 1,
    name: "SNS&GHOST NFT",
    brief: "",
    description: "The SNS&GHOST NFT Gifts for the $GHOST Community.",
    blurb: "",
    keywords: "",
    web: "",
    telegram: "",
  ...
  {
    id: "p5rex-yqaaa-aaaag-qb42a-cai",
    priority: 1,
    name: "SNS&GHOST NFT",
    brief: "",
    description: "",
...
describe("nft test suite", () => {
  ...
  describe("nft", () => {
    beforeEach(() => {
      ...
      jest
        .spyOn(require("src/integration/entrepot/lib"), "fetchCollections")
        .mockResolvedValue(
          mockCollections.reduce(
            ...
            {} as Record<string, (typeof mockCollections)[0]>,
          ),
        )

      // Mock global fetch for transaction APIs
      global.fetch = jest.fn((url: string | URL) => {
        const urlString = typeof url === "string" ? url : url.toString()

        // Mock entrepot collections API
        if (urlString.includes("/collections")) {
        ...
        // Mock EXT token transactions API
          ...
          return Promise.resolve({
            ...
            json: async () => ({
              ...
              transactions: [
                {
                  id: "1",
                  token: "yfmjl-eakor-uwiaa-aaaaa-c4a2i-qaqca-aabaj-a",
                  canister: "p5jg7-6aaaa-aaaah-qcolq-cai",
                  time: 1642480166000, // Jan 18, 2022 - 05:29:26 am
                  seller:
        ...
        // Mock MEMECAKE transactions API
        if (urlString.includes("memecake.io/api/nft/token/")) {
          return Promise.resolve({
            ok: true,
            json: async () => ({
              status: 200,
              ...
              data: [
                {
                  ...
                  tokenAddress: "ubfjy-6qkor-uwiaa-aaaaa-byanl-4aqca-aacof-a",
                  __v: 0,
                  transactionAmount: 45000000, // 0.45 ICP
                  transactionDate: "2024-07-17T22:02:35.000Z",
                  transctionType: "Sale",
                  trxStat: "",
                  trxDetailId: "",
                ...
                },
                {
                  ...
                  __v: 0,
                  transactionAmount: 0,
                  transactionDate: "2024-07-17T21:00:00.000Z",
    ...
    it("should return", async () => {
      ...
      // Mock ICPSWAP actor methods
      jest
        .spyOn(require("@nfid/integration"), "actorBuilder")
        .mockImplementation((...args: any[]) => {
          const canisterId = args[0] as string
          return {
            icsMetadata: jest.fn().mockResolvedValue({
              ok: {
                cId: canisterId,
                filePath: `https://${canisterId}.raw.ic0.app/100000`,
                fileType: "video",
                introduction:
                  "The SNS&GHOST NFT Gifts for the $GHOST Community.",
              },
            }),
            canisterInfo: jest.fn().mockResolvedValue({
              ok: {
                name: "SNS&GHOST NFT",
                symbol: "",
                logo: "",
            ...
            findTxRecord: jest.fn().mockResolvedValue({
              ok: {
                content: [
                  {
                    from: "f314402b0e472cd9fef4a533d7aab99041dbf794fee556bb5cd785ed3b1a4a99",
                    to: "0051449d6ed40385865c7ddd44e1ce87a4e0c3d054bd86b936a9aedf094f62df",
                    timestamp: BigInt(1721253476000), // Jul 17, 2024 - 09:57:56 pm
                    token: "100000",
                  ...
                  },
                  {
                    from: "",
                    to: "",
                    timestamp: BigInt(1721253475000),
                    token: "100000",
                    txType: { Transfer: null },
                    price: undefined,
                  },
                  {
                    from: undefined,
                    to: "af8283ad383bc6e16509683b3256fdb4a5d2ece25261e8c39b1677bab7019e44",
                    timestamp: BigInt(1670404428000), // Dec 07, 2022 - 08:53:48 am
                    token: "100000",
                    txType: { Mint: null },
                    price: BigInt(0),
                  },
                ],
                totalElements: BigInt(3),
              },
            }),
          }
        })

      // Mock ICPSWAP properties service
      jest
        .spyOn(
          require("src/integration/nft/impl/icpswap/properties/properties-service")
            .icpSwapPropertiesService,
          "getProperties",
        )
        .mockResolvedValue({
          mappedValues: [
            { category: "Background", option: "Purple" },
            { category: "Color", option: "Blue" },
            { category: "Shape", option: "Round" },
            { category: "Size", option: "Large" },
            { category: "Type", option: "Special" },
          ],
        })
