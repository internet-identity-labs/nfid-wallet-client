...
export type RPCControllerContext = {
...
export const RPCControllerMachine =
  ...
  createMachine(
    {
      ...
      schema: {
        events: {} as Events,
        context: {} as RPCControllerContext,
      },
      id: "RPCController",
      initial: "Initial",
      states: {
...
export type RPCControllerMachineActor = ActorRefFrom<
  typeof RPCControllerMachine
>

export default RPCControllerMachine
