...
import {expectedAttributesResponse, mockAttributesResponse} from "src/integration/nft/impl/ext/properties/mock";
...
describe("nft test suite", () => {
    it('should return nft properties', async function () {
      ...
      let actual = await extPropertiesService.getProperties("o6lzt-kiaaa-aaaag-qbdza-cai", 4234)
