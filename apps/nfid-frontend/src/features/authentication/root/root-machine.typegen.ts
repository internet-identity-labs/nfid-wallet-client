...
"done.invoke.shouldShowPasskeys": { type: "done.invoke.shouldShowPasskeys"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.shouldShowPasskeys6th": { type: "done.invoke.shouldShowPasskeys6th"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.shouldShowRecovery8th": { type: "done.invoke.shouldShowRecovery8th"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
...
"assignAuthSession": "AUTHENTICATED" | "SIGN_IN_PASSKEY" | "done.invoke.AuthWithEmailMachine" | "done.invoke.AuthWithGoogleMachine";
"assignEmail": "AUTH_WITH_GOOGLE";
"assignIsEmbed": "AUTH_WITH_EMAIL" | "AUTH_WITH_GOOGLE" | "AUTH_WITH_OTHER";
"assignShowPasskeys": "done.invoke.shouldShowPasskeys" | "done.invoke.shouldShowPasskeys6th";
...
"showPasskeys": "done.invoke.shouldShowPasskeys" | "done.invoke.shouldShowPasskeys6th";
...
"shouldShowPasskeys": "done.invoke.AuthWithEmailMachine" | "done.invoke.AuthWithGoogleMachine";
"shouldShowPasskeys6th": "AUTHENTICATED" | "done.invoke.checkIf2FAEnabled";
"shouldShowRecovery8th": "AUTHENTICATED" | "SIGN_IN_PASSKEY" | "done.invoke.shouldShowPasskeys6th";
        };
        matchesStates: "AddPasskeys" | "AddPasskeysSuccess" | "AuthSelection" | "AuthSelectionSignUp" | "AuthWithGoogle" | "BackupWallet" | "BackupWalletSavePhrase" | "EmailAuthentication" | "End" | "OtherSignOptions" | "SignInWithRecoveryPhrase" | "SignUpPassKey" | "SignUpWithEmail" | "SignUpWithGoogle" | "TwoFA" | "check2FA" | "checkPasskeys" | "checkPasskeys6th" | "checkRecovery8th";
        tags: never;
      }
