...
Feature: Register a new NFID device
  ...
  Scenario Outline: User registers a new device with
    ...
    When I click the "<qrcode>" attribute on the homePage
    ...
    Examples:
      ...
      | The Identity Layer | #home > div:nth-child(1) > div.sticky.z-30.sm\:mt-40.top-28 > div > div > h1 | .container > .h-full > .h-full > .flex > .btn | .col-span-12 > div > .rounded-md > .flex > .flex-1  | .flex > .container > .grid > .col-span-12 > .my-3 | .relative > .react-reveal > .mb-\\[20vh\\] > .flex > .center|
