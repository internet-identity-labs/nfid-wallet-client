...
const Tab: React.FC<ITab> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={clsx(
            "relative",
            hasNotification &&
              "after:rounded-full after:my-auto after:content-[''] after:absolute after:w-2 after:h-2 after:bg-red-600 dark:after:bg-red-500 after:top-0 after:bottom-0 after:right-[-15px]",
          )}
        >
          {children}
        </div>
      ...
      <motion.div
        className="absolute left-0 bottom-[-2px] h-[2px] bg-teal-600 dark:bg-teal-500"
