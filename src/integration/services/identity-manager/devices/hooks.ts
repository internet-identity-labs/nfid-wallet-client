...
<<<<<<< HEAD:src/integration/identity-manager/devices/hooks.ts
import {
  AccessPointRequest,
  AccessPointResponse,
...
>>>>>>> f6fa3cda (feat: phone credential verification):src/integration/services/identity-manager/devices/hooks.ts
import {
  addDevice,
  authState,
  creationOptions,
