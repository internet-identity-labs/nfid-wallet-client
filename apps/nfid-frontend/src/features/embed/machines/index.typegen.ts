...
export interface Typegen0 {
    '@@xstate/typegen': true;
    internalEvents: {
        "done.invoke.EmbedConnectAccountMachine": { type: "done.invoke.EmbedConnectAccountMachine"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
        ...
        "done.invoke.SignTypedDataService": { type: "done.invoke.SignTypedDataService"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
        ...
        "error.platform.EmbedConnectAccountMachine": { type: "error.platform.EmbedConnectAccountMachine"; data: unknown };
        "error.platform.SendTransactionService": { type: "error.platform.SendTransactionService"; data: unknown };
        "error.platform.SignTypedDataService": { type: "error.platform.SignTypedDataService"; data: unknown };
    ...
    eventsCausingActions: {
        ...
        "assingError": "error.platform.SendTransactionService" | "error.platform.SignTypedDataService";
        "nfid_authenticated": "done.invoke.authenticate";
        "sendRPCResponse": "done.invoke.EmbedConnectAccountMachine" | "done.invoke.SendTransactionService" | "done.invoke.SignTypedDataService" | "error.platform.SendTransactionService" | "error.platform.SignTypedDataService" | "xstate.stop";
    };
    eventsCausingDelays: {
    ...
    eventsCausingServices: {
        "AuthenticationMachine": "CONNECT_ACCOUNT" | "SEND_TRANSACTION" | "SIGN_TYPED_DATA" | "xstate.init";
        "EmbedConnectAccountMachine": "CONNECT_ACCOUNT";
        "SendTransactionService": "SEND_TRANSACTION";
        "SignTypedDataService": "SIGN_TYPED_DATA";
    };
    matchesStates: "AuthenticationMachine" | "ConnectAccount" | "Error" | "Ready" | "SendTransaction" | "SignTypedDataV4";
    tags: never;
}
