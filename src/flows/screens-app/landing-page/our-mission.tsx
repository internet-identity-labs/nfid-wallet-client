                ...
                <div className="relative z-20 text-base sm:text-lg sm:leading-[26px] tracking-[0.01em]">
                  <div className="sm:mt-5">
                    ...
                    <p className="mt-[10px] sm:mt-5">
                      ...
                      behavior. The war in Ukraine is just one of many examples:
                      Ukrainians today by the hundreds of thousands are facing
                      difficulty accessing existing and opening new bank
                      accounts, protestors in Russia against the war risk
                      detainment for speaking out against the government, and
                      the Russian propaganda machine is working so well partly
                      because it’s able to run hyper-targeted messaging
                      campaigns from the massive amount of information we
                      unknowingly reveal about ourselves.
                    </p>
                  </div>
                  <div className="sm:mt-5">
                    ...
                    <p className="mt-[10px] sm:mt-5">
                      This is the world we live in today because our identities
                      aren’t really ours, they belong to the companies and
                      governments that provide us with the promise of security
                      and convenience in exchange for our privacy. Sign in with
                      Big Tech to exchange no-password log-ins for surveillance
                      of our online activity on a previously unimaginable scale.
                      Receive a single number, passport, or identification card
                      from the government to exchange how we prove we are who we
                      say we are for surveillance anytime those documents are
                      used. Keep money in a bank to exchange the convenience of
                      its (relative) safe-keeping for the surveillance and
                      control of its use.
                    </p>
                  </div>
                  <div className="sm:mt-5">
                    ...
                    <p className="mt-[10px] sm:mt-5">
                      ...
                      seizure, we are not free to speak our mind without risking
                      consequences, and we are not free from becoming the
                      subject of targeted manipulation until we’re in control of
                      our own identity. Until today, achieving this level of
                      freedom was either impossible or impractically
                      inconvenient.
                    </p>
                  </div>
                  <div className="sm:mt-5">
