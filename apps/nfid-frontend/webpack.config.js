...
// createRequire provides synchronous require() in an ESM file — used for:
// 1. dotenv (must load before env vars are read)
// 2. require.resolve() — no ESM equivalent
// 3. JSON imports (dfx.json)
...
// getServiceConfig() reads process.env at call time — must run after loadEnvForWebpack()
