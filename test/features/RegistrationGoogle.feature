...
Feature: Registration using Google
  ...
  Scenario Outline: User wants to register with Google
    ...
    Then I wait on element "#captcha-img" for 7000ms to be displayed
    ...
    Then I wait on element "#profile" for 1000ms to be displayed
    When I click on the selector "#profile"
    Then I wait on element "#logout" for 1000ms to be displayed
