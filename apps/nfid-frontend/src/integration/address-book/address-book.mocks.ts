...
export const ALICE_ICP_ADDRESS_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Alice",
  address: {
...
export const ALICE_ICP_PRINCIPAL_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Alice",
  address: {
...
export const ALICE_BTC_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Alice",
  address: {
...
export const ALICE_EVM_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Alice",
  address: {
...
export const BOB_ICP_ADDRESS_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Bob",
  address: {
    type: AddressType.ICP_ADDRESS,
...
export const BOB_ICP_PRINCIPAL_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Bob",
  address: {
    type: AddressType.ICP_PRINCIPAL,
    value: "bbbbb-bb",
...
export const CHARLIE_BTC_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Charlie",
  address: {
    type: AddressType.BTC,
...
export const CHARLIE_EVM_PREVIEW: Omit<UserAddressPreview, "id"> = {
  name: "Charlie",
  address: {
    type: AddressType.ETH,
