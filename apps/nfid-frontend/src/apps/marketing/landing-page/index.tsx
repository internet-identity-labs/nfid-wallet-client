                ...
                <Fade right>
                  ...
                  >
                    ...
                    <p className="z-20 mt-5 text-base font-normal md:text-lg md:leading-[26px]">
                      Traditionally, you give applications your email address or
                      other reusable identifier as a way of identifying you.
                      Unfortunately, this immediately links you with all the
                      other accounts you’ve ever used that same identifier for.
                      When you connect to applications with NFID, you’re giving
                      that application a completely new random identifier for
                      yourself that they can’t associate with any of your other
                      internet accounts.
                    </p>
                  </Parallax>
                </Fade>
                ...
                <Fade right>
                  ...
                  >
                    ...
                    <p className="mt-5 text-base font-normal md:text-lg md:leading-[26px]">
                      Crypto wallets have explored ways of sending and receiving
                      data, like cryptocurrencies and NFTs. What they haven’t
                      been able to do is protect their owners from surveillance
                      of all trading activity. NFID grants you protection from
                      this kind of surveillance by keeping your assets siloed in
                      app-specific wallets until you choose to reveal them.
                    </p>
                  </Parallax>
                </Fade>
                {/* @ts-ignore: TODO: Pasha fix */}
                <Fade right>
                  ...
                  >
                    ...
                    <p className="mt-5 text-base font-normal md:text-lg md:leading-[26px]">
                      ...
                      sell your data without your consent and share none of the
                      profits. Invert the power dynamic with NFID — ask not what
                      you can do for your applications, ask what your
                      applications can do for you! That’s right, never fill out
                      the same form twice with NFID.
                    </p>
                  </Parallax>
                </Fade>
              </div>
                  ...
                  <Fade bottom>
                    <div className="">
                      ...
                      <p className="mt-5 text-base md:text-lg md:leading-[26px]">
                        ...
                        untraceable hardware wallet. You are the only person in
                        the world able to trace accounts to your NFID, providing
                        you with the best possible privacy online.
                      </p>
                    </div>
                  </Fade>
                  {/* @ts-ignore: TODO: Pasha fix */}
                  ...
                  <Fade bottom>
                    <div className="">
                      ...
                      <p className="mt-5 text-base md:text-lg md:leading-[26px]">
                        ...
                        because their private keys can't be exported, making it
                        a one-way vault that only you have the ability to
                        access. NFID makes each of your internet accounts
                        exactly this kind of vault.
                      </p>
                    </div>
                  </Fade>
                </div>
