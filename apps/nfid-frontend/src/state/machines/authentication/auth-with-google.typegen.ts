...
"done.invoke.fetchGoogleDeviceService": { type: "done.invoke.fetchGoogleDeviceService"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"done.invoke.signInWithGoogleService": { type: "done.invoke.signInWithGoogleService"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"error.platform.checkRegistrationStatus": { type: "error.platform.checkRegistrationStatus"; data: unknown };
"error.platform.fetchGoogleDeviceService": { type: "error.platform.fetchGoogleDeviceService"; data: unknown };
"error.platform.signInWithGoogleService": { type: "error.platform.signInWithGoogleService"; data: unknown };
