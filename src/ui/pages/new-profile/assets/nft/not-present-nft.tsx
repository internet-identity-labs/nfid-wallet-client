...
export const ProfileNFTNotPresent: React.FC<IProfileAssetsNFT> = () => {
  return (
    <ProfileContainer
      title="Your NFTs"
    ...
    >
      <div className="text-neutral-900 text-sm leading-5 max-w-[320px] z-20 relative">
        <p>
          NFTs in the EXT standard you received to your main NFID wallet or any
          application where you signed in with NFID will be listed here. If
          you’ve connected your II anchor with NFID, EXT NFTs in those connected
          wallets will also be available.
        </p>
        <p className="mt-4">
          Email us at{" "}
