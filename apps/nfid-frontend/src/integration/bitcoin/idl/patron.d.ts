...
export type AllowSigningStatus =
  | { Skipped: null }
  | { Failed: null }
  | { Executed: null }
...
export type SaveTestnetsSettingsError =
  | { VersionMismatch: null }
  | { UserNotFound: null }
...
export interface _SERVICE {
  add_user_credential: ActorMethod<
  ...
  top_up_cycles_ledger: ActorMethod<
    [[] | [TopUpCyclesLedgerRequest]],
