...
describe("validate derivation origin test suite", () => {
  ...
  it("should return invalid when alternativeOrigns array contains more than 10 entries", async () => {
    ...
    expect(response).toEqual({
      result: "invalid",
      message: `Resource https://rrkah-fqaaa-aaaaa-aaaaq-cai.icp0.io/.well-known/ii-alternative-origins has too many entries: To prevent misuse at most ${MAX_ALTERNATIVE_ORIGINS} alternative origins are allowed.`,
    })
  })
