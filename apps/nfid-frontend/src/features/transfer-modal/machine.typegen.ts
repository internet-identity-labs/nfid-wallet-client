...
"isSwapMachine": "";
        ...
        matchesStates: "Hidden" | "ReceiveMachine" | "SendMachine" | "SendMachine.CheckSendType" | "SendMachine.SendFT" | "SendMachine.SendNFT" | "SwapMachine" | "SwapSuccess" | "TransferModal" | "TransferSuccess" | { "SendMachine"?: "CheckSendType" | "SendFT" | "SendNFT"; };
        tags: never;
      }
