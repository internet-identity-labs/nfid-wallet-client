...
export class ArbSepoliaTransactionService extends EVMNativeTransactionService {
...
export const arbSepoliaTransactionService = new ArbSepoliaTransactionService()
