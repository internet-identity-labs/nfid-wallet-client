...
Feature:Non Fungible Asset
  ...
  Scenario Outline: User should be able to see collectibles page
    ...
    Examples:
      ...
      | 7      | 31870  | AnilAnimal    | Rarible    | 3              | NFIDaccount1 | 22558361690228810656161743101174268944760789894532108532742266930527975981633 | Polygon Mumbai   |
      | 7      | 31870  | TestERC1155   | Rarible    | 2              | NFIDaccount1 | 94667527331073441490639696296732950748865385440430584394830104056550742032385 | Ethereum Goerli  |
      | 7      | 31870  | PandaQueen571 | PandaQueen | 2              | NFIDaccount1 | jzwaa-zikor-uwiaa-aaaaa-b4avk-qaqca-aaai5-q                                   | InternetComputer |
