...
ci_echo_info "Building playground ..." >&2
ci_echo_debug "npx env-cmd -f .env.dev nx build nfid-demo" >&2
npx env-cmd -f .env.dev nx build nfid-demo
...
ci_echo_info "Running playground on port '${DEMO_PORT}' ..." >&2
