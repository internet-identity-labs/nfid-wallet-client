...
export function TokenLaunch({
  ...
  return (
    <div
      className={clsx(
        "w-full p-0 lg:p-[20px] border border-0 lg:border border-gray-100 lg:rounded-[24px]",
        className,
      )}
    >
      <div className="mt-[-10px]">
        ...
        <div className="mt-[-10px]">
          ...
          <p className="text-sm mb-[20px] block">
            The first wallet with the potential to let you pay on any chain,
            with any token, is now going fully decentralized!
          </p>
          <p className="text-sm mb-[20px] block">
            Don’t miss out on shaping the future of Web3 with NFID Wallet.
            Follow{" "}
            <a
