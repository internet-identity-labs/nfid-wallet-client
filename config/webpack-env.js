...
// Must be called after dotenv has been loaded so process.env is populated.
export function getServiceConfig() {
  return {
    ...
    AWS_LINK_GOOGLE_ACCOUNT: JSON.stringify(
      process.env.AWS_LINK_GOOGLE_ACCOUNT,
    ),
    ...
    AWS_ECDSA_GET_ANONYMOUS: JSON.stringify(
      process.env.AWS_ECDSA_GET_ANONYMOUS,
    ),
