...
import {  EthWalletV2 } from "./ecdsa-wallet-v2";
import { DelegationIdentity, Ed25519KeyIdentity } from "@dfinity/identity";
import { authState, ecdsaSigner, generateDelegationIdentity, ii, replaceActorIdentity } from "@nfid/integration";
import {
...
describe("ECDSA suite", () => {
  ...
  it("nfid-wallet verify message", async () => {
    ...
    nfidWallet = new EthWalletV2(rpcProvider).init(delegationIdentity);
