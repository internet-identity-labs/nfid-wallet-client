...
Feature:Non Fungible Asset
  ...
  Scenario Outline: User should be able to see collectibles page
    ...
    Examples:
      ...
      | 6      | 31870  | AnilAnimal    | Rarible    | 3              | NFIDaccount1 | 22558361690228810656161743101174268944760789894532108532742266930527975981633 | Polygon Mumbai   |
      | 6      | 31870  | TestERC1155   | Rarible    | 1              | NFIDaccount1 | 94667527331073441490639696296732950748865385440430584394830104056550742032385 | Ethereum Goerli  |
