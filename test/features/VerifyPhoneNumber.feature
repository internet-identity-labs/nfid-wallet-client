...
Feature: User wants to veirfy his phone number
  ...
  Scenario Outline: User wants to veirfy his phone number
    ...
    Then I wait on element "#loader" for 15000ms to not be displayed
    Then I wait on element "#pin-input input:first-child" for 1000ms to be displayed
    When I click on the selector "#pin-input input:first-child"
    And  I expect that element "#pin-input input:first-child" not contains any text
    When I press "100000"
