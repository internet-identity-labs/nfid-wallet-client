    ...
    switch (true) {
        ...
        case state.matches('AuthWithGoogle'):
            return <AuthorizeDecider
                ...
                onSelectGoogleAuthorization={({ credential }) => send({ type: 'AUTH_WITH_GOOGLE', data: credential as string })}
    ...
    switch (true) {
        ...
        case state.matches('GetDelegation'):
            ...
            ><AuthorizeApp
                    ...
                    onLogin={async (persona) => send({ type: "SELECT_ACCOUNT", data: persona })}
