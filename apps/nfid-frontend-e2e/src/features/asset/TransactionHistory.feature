...
Feature:Fungible Asset History
  ...
  Scenario Outline: User should be able to see transaction history in <tab>
    ...
    Examples:
      ...
      # disabled for now because some faucet sent us some weird token as advertisement
      ...
      # | 2   | Received | Ethereum | ETH      | 0.1     | 1682378592000 | 0xb1107f4141fb56b07d15b65f1629451443ff8f8e | 0xeaf87e4ddf980280b64f860b1af9bf7decb2e780 | 28593  |
      # | 6   | Received | Ethereum | FAU      | 1       | 1682580072000 | 0x91a636095fa65511a30a9d9ac29549984ad25741 | 0x00607c1f864508e7de80b6db6a2cef775b9f01e7 | 25795  |
  ...
  Scenario Outline: User should be able to see transaction depends on selected app
    ...
    Examples:
      ...
      | Received | Ethereum          | 25795  | 10 TXs | 6    |
      | Sent     | Bitcoin           | 28593  | 8 TXs  | 2    |
      | Sent     | Ethereum          | 28593  | 8 TXs  | 1    |
