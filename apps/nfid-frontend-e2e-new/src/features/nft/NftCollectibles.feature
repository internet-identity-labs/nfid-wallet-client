...
Feature:Non Fungible Asset
  ...
  Scenario Outline: User should be able to see collectibles page
    ...
    Examples:
      ...
      | 7      | 31870  | AnilAnimal    | 0x67a8fe17db4d441f96f26094677763a2213a3b5f | 3              | NFIDaccount1 | 22558361690228810656161743101174268944760789894532108532742266930527975981633 | Polygon Mumbai   |
      | 7      | 31870  | TestERC1155   | 0x7c4b13b5893cd82f371c5e28f12fb2f37542bbc5 | 2              | NFIDaccount1 | 94667527331073441490639696296732950748865385440430584394830104056550742032385 | Ethereum Goerli  |
