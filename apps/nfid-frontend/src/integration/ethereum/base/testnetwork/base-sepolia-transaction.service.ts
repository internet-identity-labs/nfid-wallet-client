...
export class BaseSepoliaTransactionService extends EVMNativeTransactionService {
...
export const baseSepoliaTransactionService = new BaseSepoliaTransactionService()
